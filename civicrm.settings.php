 ...
 * Pantheon Systems:
 *
 * Repopulate needed variables based on the Pantheon or Lando environment if applicable.
 *
 */
if (!empty($_SERVER['PRESSFLOW_SETTINGS'])) {
  $env = $_SERVER['PRESSFLOW_SETTINGS'];

  //strip out backslashes, otherwise json_decode returns null
  ...
  if (!empty($env['conf']['pantheon_binding'])) {
    ...
    //host
    $db_string .= $_SERVER['DB_HOST'] . ':' . $pantheon_db['port'];
    // database
...
if (defined('PANTHEON_ENVIRONMENT') && in_array(PANTHEON_ENVIRONMENT, array('dev', 'test', 'live'))) {
  $civicrm_paths['wp.frontend.base']['url'] = $base_url;
  $civicrm_paths['wp.backend.base']['url'] = $base_url . '/wp-admin/';
  $civicrm_setting['URL Preferences']['userFrameworkResourceURL'] = $base_url . '/wp-content/plugins/civicrm/civicrm';
}
...
if (defined('PANTHEON_ENVIRONMENT') && in_array(PANTHEON_ENVIRONMENT, array('dev', 'test', 'live'))) {
  $civicrm_root = '/srv/bindings/' . $_SERVER["USER"] . '/code/wp-content/plugins/civicrm/civicrm/';

  if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
    define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/srv/bindings/' . $_SERVER["USER"] . '/files/civicrm/templates_c/');
  }
}

else {
  $civicrm_root = '/app/wp-content/plugins/civicrm/civicrm/';

  if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
    define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/app/wp-content/uploads/civicrm/templates_c/');
  }
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'a846e520d3ce44ce9623e158d75616e0');
}
...
// define( 'CIVICRM_MAIL_LOG', '/srv/bindings/fd9ecea178bf4d29869453d87ce08b7d/code/wp-content/uploads/civicrm/templates_c//mail.log');
// }
